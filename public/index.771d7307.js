...
})({"bW85h":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "dd34b663771d7307";
...
class Fire {
    ...
    render() {
        this.clearCanvas();
        // draw particles
        if (this.particles.length < 100) this.particles.push(new Particle(this.mouse_x, this.mouse_y, this.size));
        else {
...
class Particle {
    constructor(init_x, init_y, init_size = 20){
    ...
    render(ctx) {
        ...
        ctx.fillStyle = `rgb(250,${200 * (1 - frame / numOfFrames)},0,${1 - frame / numOfFrames})`;
        ctx.beginPath();
        const randomNumber = Math.random();
        ctx.arc(this.init_x + frame / numOfFrames * Math.sin(frame * randomNumber) * 2, this.init_y - frame * 2, this.init_size * Math.abs(1 - frame / numOfFrames), 0, 2 * Math.PI);
        ctx.fill();
    }
}
...
},{}]},["bW85h","jeorp"], "jeorp", "parcelRequired18f")

//# sourceMappingURL=index.771d7307.js.map
